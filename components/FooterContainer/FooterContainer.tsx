  ...
  return (
    <section className="w-full bg-black md:rounded-tl-full md:rounded-tr-full rounded-tr-3xl rounded-tl-3xl mt-10">
      ...
      <div className="text-center p-6">
        <Link href="#" as={"/"}>
          <a className="text-white pb-2 relative after:bg-white after:absolute after:h-1 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 cursor-pointer ">
